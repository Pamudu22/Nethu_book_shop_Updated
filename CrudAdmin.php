...
if (isset($_POST['addC'])) {
    ...
    if ($mysqli->query($sqlC) === TRUE) {
        $_SESSION['messg'] = "Category uploaded successfully";
        header("Location: Admin_Book_Manager.php");
        exit(0);
    }
}
...
if (isset($_POST['addP'])) {
    ...
    if ($mysqli->query($sqlC) === TRUE) {
        $_SESSION['messg'] = "Publisher uploaded successfully";
        header("Location: Admin_Book_Manager.php");
        exit(0);
    }
}
...
if (isset($_POST['addA'])) {
    ...
    if ($mysqli->query($sqlC) === TRUE) {
        $_SESSION['messg'] = "Author uploaded successfully";
        header("Location: Admin_Book_Manager.php");
        exit(0);
    }
}
...
if (isset($_POST['DeletC'])) {
    ...
    if ($mysqli->query($sqlD) === TRUE) {
        ...
        if ($affec > 0) {
            $_SESSION['messg'] = "Category deleted successfully";
        } else {
...
if (isset($_POST['DeleteA'])) {
    ...
    if ($mysqli->query($sqlD) === TRUE) {
        $affec = $mysqli -> affected_rows;
        if ($affec > 0) {
            $_SESSION['messg'] = "Author deleted successfully";
        } else {
...
if (isset($_POST['DeleteP'])) {
    ...
    if ($mysqli->query($sqlD) === TRUE) {
        $affec = $mysqli->affected_rows;
        if ($affec > 0) {
            $_SESSION['messg'] = "Publisher deleted successfully";
        } else {
    ...
    if ($result) {
        ...
        if ($affec > 0) {
            ...
            if ($mysqli->query($sqlU)) {
                $_SESSION['messg'] = "Publisher Updated successfully";
            } else {
                $_SESSION['status'] = "Error updating publisher: " ;
                $_SESSION['status_code'] = "error";
            }
        } else {
            $_SESSION['status'] = "Publisher Not Found in Database";
        ...
        $_SESSION['status'] = "Error fetching publisher: " ;
        $_SESSION['status_code'] = "error";
    }
...
if (isset($_POST['updateC'])) {
    ...
    if ($result) {
        ...
        if ($affec > 0) {
            ...
            if ($mysqli->query($sqlU)) {
                $_SESSION['messg'] = "Category Updated successfully";
            } else {
        ...
        $_SESSION['status'] = "Error fetching category: " ;
        $_SESSION['status_code'] = "error";
    }
...
if (isset($_POST['updateA'])) {
    ...
    if ($result) {
        ...
        if ($affec > 0) {
            ...
            if ($mysqli->query($sqlU)) {
                $_SESSION['messg'] = "Author Updated successfully";
            } else {
                $_SESSION['status'] = "Error updating author: " ;
                $_SESSION['status_code'] = "error";
            }
        } else {
            $_SESSION['status'] = "Author Not Found in Database";
        ...
        $_SESSION['status'] = "Error fetching author: " ;
        $_SESSION['status_code'] = "error";
    }
