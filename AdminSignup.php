        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-warning active" aria-current="page" href="AdminSignup.php">Sign-up</a>
                    </li>
                    <li class="nav-item">
              ...
              <div class="card-body p-md-5">
                <div class="row justify-content-center">
                  <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    ...
                    <form class="mx-1 mx-md-4" action="signupPrcs.php" method="POST" novalidate name="Signupform"
                      ...
                      <div class="d-flex flex-row align-items-center mb-4">
                        ...
                        <div class="form-outline flex-fill mb-0">
                          ...
                          <input required type="email" id="Email" name="Email" class="form-control"
                            placeholder="ex:-nethu@gmail.com" />
                      ...
                      <script>
                        ...
                        function validateForm() {
                          ...
                          // Check if the password meets the required criteria (e.g., at least 8 characters long, contains at least one uppercase letter, one lowercase letter, and one special character)
                      ...
                      <button type="submit" class="btn btn-primary btn-lg" onclick="return validateForm()">Register</button>
                      </div>
                  ...
                  <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                    ...
                    <img src="pngwing.png" class="img-fluid" alt="Sample image">
