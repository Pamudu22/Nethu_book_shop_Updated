...
<html lang="en">
  <head>
    ...
    <script>
         function totalclick(row, click) {
        const totalclick = document.getElementById(`totalclick-${row}`);
        const currentValue = parseInt(totalclick.innerText);
        const newValue = currentValue + click;

        if (newValue >= 1) {
            totalclick.innerText = newValue;
        }
    }
                      ...
                      while ($row = mysqli_fetch_assoc($allproduct)) {
                        ...
                        <form action="" method="post">
                          <div class="row mb-4 d-flex justify-content-between align-items-center">
                            ...
                            <button class="input-group-text" type="button" onclick="totalclick(<?php echo $i; ?>, -1)">-</button>
                             <span class="input-group-text" id="totalclick-<?php echo $i; ?>">1</span>
                             <button class="input-group-text" type="button" onclick="totalclick(<?php echo $i; ?>, 1)">+</button>
                            </div>
