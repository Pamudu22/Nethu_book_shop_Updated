...
<html lang="en">
  ...
  function updateQuantityInDatabase(row, newQuantity) {
    ...
    xhttp.open("POST", "updateQuantityInDatabase.php", true); // Replace "updateQuantityInDatabase.php" with your server-side script to update the quantity
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send(`row=${row}&quantity=${newQuantity}`);
  }
  ...
  function updateQuantity(row) {
    ...
    if (newQuantity >= 1 && newQuantity <= 10) {
      ...
      updateQuantityInDatabase(row, newQuantity);
    }
  }
  ...
  function calculateTotalPrice() {
    ...
    document.getElementById('overallTotalPrice').innerText = `Rs. ${overallTotalPrice.toFixed(2)}`;
  }
  ...
  window.onload = function () {
    ...
    allProductElements.forEach((element) => {
      ...
      // Add event listener to the quantity input element
      document.getElementById(`quantity-${row}`).addEventListener('change', function () {
    ...
    // Calculate and display the initial overall total price
    calculateTotalPrice();
  };
                        ...
                        <form action="" method="post">
                          <div class="row mb-4 d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                <button class="input-group-text" type="button" onclick="updateQuantity(<?php echo $i; ?>, -1)">-</button>
                                <input type="number" id="quantity-<?php echo $i; ?>" class="form-control form-control-sm" value="1" min="1" max="10" onchange="updateQuantity(<?php echo $i; ?>, 0)">
                                <button class="input-group-text" type="button" onclick="updateQuantity(<?php echo $i; ?>, 1)">+</button>
                            </div>
              ...
              <div class="col-lg-4 bg-grey">
                <div class="p-5">
                  ...
                  <div class="d-flex justify-content-between mb-5">
                    ...
                    <h5>Rs. <?php echo $overallTotalPrice; ?>.00</h5>
                  </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-4 col-xl-6">
              <div class="row">
                ...
                <div class="col-12 col-xl-6">
                  <div class="form-outline mb-4 mb-xl-5">
                    <input type="text" id="typedText" class="form-control form-control-lg" siez="17"
