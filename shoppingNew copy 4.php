...
<html lang="en">
  <head>
    ...
    <script>
 function updateQuantityInDatabase(scartID, newQuantity) {
    ...
    xhttp.send(`scartID=${scartID}&quantity=${newQuantity}`);
  }

  function updateQuantity(row, increment, scartID) {
    console.log(scartID);
  ...
  if (newQuantity >= 1 && newQuantity <= 10) {
    ...
    updateQuantityInDatabase(scartID, newQuantity);
  }
}
                      ...
                      while ($row = mysqli_fetch_assoc($allproduct)) {
                        ...
                        <form action="" method="post">
                          <div class="row mb-4 d-flex justify-content-between align-items-center">
                            ...
                            <button class="input-group-text" type="button" data-row="<?php echo $i; ?>" data-scartID="<?php echo $row['ScartID']; ?>" onclick="updateQuantity(<?php echo $i; ?>, -1, <?php echo $row['ScartID']; ?>)">-</button>
    ...
    <!--card payment-->
      <div class="card shadow-2-strong mb-5 mb-lg-0" style="border-radius: 16px; background-color: rgba(255, 255, 255, 0.847); margin: 5%;">
        <div class="card-body p-4">
          ...
          <a class="btn btn-primary" style="margin-left: 75%;" data-bs-toggle="modal" href="#exampleModalToggle" role="button" >Checkout</a>
