      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          if(isset($_POST['submit'])){
            ...
            $sql = "SELECT b.Book_Name, b.ISBN_No, a.author_name AS Author_Name, p.publisher AS Publisher_Name, b.Book_Price, b.Language, b.image_url, b.image_name
            FROM book b
            INNER JOIN author a ON b.author_fk = a.author_id
            INNER JOIN publisher p ON b.publisher_fk = p.publisher_id
            WHERE b.ISBN_No LIKE '%$search%' OR b.Book_Name LIKE '%$search%' OR a.author_name LIKE '%$search%' OR p.publisher LIKE '%$search%'";
